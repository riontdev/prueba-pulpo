...
class Http extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'internal_api' => [
            //'jwt.check:internal_api',
            \Src\Common\Infrastructure\Laravel\Middleware\JwtMiddleware::class,
    ...
    protected $middlewareAliases = [
        'jwt.user' => \Src\Common\Infrastructure\Laravel\Middleware\JwtMiddleware::class,
